...
export class AddEmployeeActivityByDapper extends Component {
    constructor(props) {
        super(props);
        this.state = {            
            errors: {                
    ...
    render() {
        ...
        return <div>
            ...
            <h3>Activity sign up form by Dapper</h3>
            <hr />
    ...
    handleSubmit(event) {
        ...
        if (this.validateForm(this.state.errors))
        {
            ...
            fetch('api/EmployeeActivityApiByDapper/AddEmployeeActivityByForm', {
                method: 'POST',
                body: data,
            }).then((response) => response.json())
                .then((responseJson) => {
                    this.props.history.push("/fetch-employee-activity-by-dapper");
                })
